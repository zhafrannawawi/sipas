<div class="modal fade modal-lg" id="showDetailLoanModal{{ $loan->id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white" id="detailLabel">
                    <i class="fas fa-file-alt me-2"></i> Detail Transaksi #{{ $loan->id }}
                </h5>
