<div class="modal fade modal-lg" id="showDetailLoanModal{{ $return->id }}" tabindex="-1" role="dialog"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 border-end">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control bg-light" value="{{ $return->user->name ?? '-' }}"
                                readonly />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control bg-light"
                                value="{{ $return->user->email ?? '-' }}" readonly />
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-bold small text-muted">Kontak</label>
                            <input type="text" class="form-control bg-light"
                                value="{{ $return->user->phone_number ?? '-' }}" readonly />
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control bg-light"
                                value="{{ $return->inventory->name ?? '-' }}" readonly />
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" class="form-control bg-light"
                                    value="{{ $return->loan_date->translatedFormat('d F Y') }}" readonly />
                            </div>
                            <div class="col-6 mb-3">
                                <label class="form-label fw-bold small text-muted">Rencana Kembali</label>
                                <input type="text" class="form-control bg-light"
                                    value="{{ $return->due_date->translatedFormat('d F Y') }}" readonly />
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" class="form-control bg-light" value="{{ $return->status_label }}"
                                    readonly />
                            </div>
                            <div class="col-6 mb-3">
                                <label class="form-label fw-bold small text-muted">Peminjaman Disetujui</label>
                                <input type="text" class="form-control bg-light"
                                    value="{{ $return->approvedBy->name ?? '-' }}" readonly />
                            </div>
                        </div>
