{{-- Modal konfirmasi untuk menghapus data category --}}
<div class="modal fade" id="deleteCategoryModal{{ $category->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content rounded-4 shadow-lg border-0 overflow-hidden">

            {{-- Form hapus category (DELETE request) --}}
            <form method="POST" action="{{ route('admin.category.destroy', $category->id) }}">
                ...
                <div class="modal-body p-5 text-center position-relative">
                    ...
                    <h3 class="fw-bold mb-3 text-dark">Hapus category?</h3>

                    <p class="text-muted fs-4 mb-4">
                        Kamu akan menghapus data category ini secara permanen. <br>
