...
<div class="modal fade" id="deleteAdministratorModal{{ $administrator->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content rounded-4 shadow-lg border-0 overflow-hidden">

            {{-- Form hapus administrator (DELETE request) --}}
            <form method="POST" action="{{ route('admin.administrator.destroy', $administrator->id) }}">
                @csrf
                ...
                <div class="modal-body p-5 text-center position-relative">
                    ...
                    <h3 class="fw-bold mb-3 text-dark">Hapus Administrator?</h3>

                    <p class="text-muted fs-4 mb-4">
                        Kamu akan menghapus data administrator ini secara permanen. <br>
                    ...
                    <div class="bg-light rounded-3 p-3 mb-4 border border-light-subtle">
                        ...
                        <span class="fw-bold text-dark fs-5">{{ $administrator->name }}</span>
                    </div>
