...
<div class="modal fade" id="editOfficerModal{{ $officer->id }}" tabindex="-1" role="dialog" aria-labelledby="modalTitleId"
    aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <!-- Form dikirim ke route officer.store -->
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="name" id="edit_name"
                                aria-describedby="name-addon" placeholder="Ahmad Fauzi" value="{{ $officer->name }}" />
                        </div>
                    </div>
