{{-- Modal konfirmasi penghapusan data peminjam --}}
<div class="modal fade" id="deleteBorrowerModal{{ $borrower->id }}" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content rounded-4 shadow-lg border-0 overflow-hidden">

            {{-- Form untuk mengirim request DELETE ke borrower.destroy --}}
            <form method="POST" action="{{ route('admin.borrower.destroy', $borrower->id) }}">
                @csrf
                ...
                <div class="modal-body p-5 text-center position-relative">
                    ...
                    {{-- Informasi peminjam untuk memastikan data yang dihapus --}}
                    <div class="bg-light rounded-3 p-3 mb-4 border border-light-subtle">
                        ...
                        <span class="fw-bold text-dark fs-5">{{ $borrower->name }}</span>
                    </div>
